...
According to the null distribution, the center of the distribution falls at 0, which means that the null hypothesis is supported, and the data does not provide convincing evidence of a difference in median number of casualties of school shootings that occured in Florida vs. other states..

The 95% confidence interval shows that we are 95% confident that the difference in median casualties of school shootings that occured in Florida vs. those that occured elsewhere is between -.05 dollars and 0.
